...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT console.log(rando); this line broke code after we changed all var to const. It happened because we called console.log after we closed function, but const is local variable and in we need to console.log it we should do it inside function
  console.log(viewed);
