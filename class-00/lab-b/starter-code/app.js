...
// 1. What is "this" when joe.scope() is invoked? Student, the constructor
//
// 2. What is "this" when joe.scopeArrow() is invoked? Window object
//
// 3. Explain why "this" is different when an arrow function is used. when an arrow function is used, the scope of the function bubbles up to the next-nearest scope. This can be an enclosing function, or if it is a deeply-nested function, the closest function that does not use an arrow function. If arrow functions are used exclusively in a file, the scope of the function will become the global window object.
//
